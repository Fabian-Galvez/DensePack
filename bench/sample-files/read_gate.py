...
def main():
    ...
    try:
        ...
        # still open every picture it was handed. 6 September 2026.
        pending = waiting()
        ...
        #    local import here made Path a local for the whole function and
        #    the vault fallback above raised before it ran.
