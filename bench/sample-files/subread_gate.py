...
from common import (bash_chars, disabled, emit, line_pull, read_event, read_leads,
...
def main():
    ...
    try:
        ...
        # number pass before the sidecar redirect below.
        ...
        # A Read of more than LINE_PULL_MAX lines is a whole read since the
        # night of 12 September 2026. The pull of a few lines passes at the
        # top of main(), through common.line_pull(); any wider range is the
        # slice-the-file route a Sonnet rebuild leg took to read a whole
        # file as text past the picture.
