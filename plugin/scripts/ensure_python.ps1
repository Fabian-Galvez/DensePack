...
# paths only, so this script finds the Python the hooks find. Every candidate gets a test
...
$py = Find-Python
if ($py) {
    # The function returns true or false. Uncaptured, that value prints before
    # the JSON and Claude Code cannot parse the message.
