---
description: Put each converted CLAUDE.md and MEMORY.md back to its original text, then delete all DensePack files that /plugin uninstall leaves behind. Run it before the uninstall.
